...
public:
    ...
    SCALAR_T getMaxDistance() {return max_distance_;}

    /// Get the truncation for the TSDF values in the map (in grid units)
    SCALAR_T getTau() const {return tau_;}
    ...
    SCALAR_T getMapResolution() const {return map_resolution_;}
    ...
    const VEC_T& getMapSize() const {return map_size_;}

    /// Get the position of the scanner in the map (in grid units)
    const VEC_T& getScannerPos() const {return scanner_pos_;}

    /// Get the map size of the x dimension in grid units
    size_t getMapGridSizeX() const {return map_grid_size_x_;}

    /// Get the map size of the y dimension in grid units
    size_t getMapGridSizeY() const {return map_grid_size_y_;}
    
    /// Get the map size of the z dimension in grid units
    size_t getMapGridSizeZ() const {return map_grid_size_z_;}
