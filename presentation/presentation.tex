...
\begin{frame}{\secname}
\begin{center}
\includegraphics[width=12cm]{images/vorgehen.png}
\end{center}
\end{frame}
...
\begin{frame}{\secname}
\begin{center}
\begin{textblock*}{12.8cm} (0.0cm, 1.7cm)
\includegraphics[width=7cm]{images/Reg_Gradient.png}
\end{textblock*}
\begin{textblock*}{12.8cm} (0.0cm, 6.7cm)
...
\begin{frame}{\secname: \subsecname}
\begin{itemize}
\item{6. Stockwerk (Distanz in Meter, Auflösung: 6,4cm)}
\begin{center}
\begin{tabular}{ccc}
\toprule
...
\end{itemize}
\item{8 Meter Labortest (Distanz in Meter, Auflösung: 6,4cm)}
\begin{center}
\begin{tabular}{cccc}
\toprule
& hin & zurück & gesamt \\ 
