...
\node[below right] at (5, 7) {\begin{minipage}{6cm}
\begin{itemize}
...
\end{itemize}
\begin{center}
\includegraphics[width=4cm]{images/pose_diff.png}
\end{center}
\begin{itemize}
...
\end{itemize}
\end{textblock*}
\begin{textblock*}{1.5cm} (3cm, 5.0cm)
\includegraphics[width=1.5cm]{images/Riegl.jpeg}
\end{textblock*}
\begin{textblock*}{15cm} (1cm, 5.0cm)
\includegraphics[width=4cm]{images/Drone.jpg}
\end{textblock*}
\end{center}
\end{frame}
