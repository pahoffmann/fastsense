...
\begin{tikzpicture}
\draw [white] (0, 2.35) rectangle +(1, 1);
...
\item{Trajektorie und TSDF-Map für jede Pose speichern}
...
\node at (21, 4) {\includegraphics[height=1.05cm]{images/rviz.png}};
...
\node [below] at (11, 3) {\begin{minipage}{3cm}
\begin{itemize}
\item{IMU}
\item{PointCloud}
\item{TSDF Map}
...
\begin{center}
\begin{tikzpicture}
\node at (0, 0) {\includegraphics[width=10cm]{images/oscilloscope.jpg}};
\draw [light] (-3.1, -2) -- (-3.1, 2);
\draw [light] (-3, -2) -- (-3, 2);
\draw [light] (0.8, -2) -- (0.8, 2);
\draw [light] (1.45, -2) -- (1.45, 2);
\draw [light] (2.48, -2) -- (2.48, 2);
\draw [light] (2.8, -2) -- (2.8, 2);
\node [light, below] at (-3.05, -2) {Preprocessing};
\node [light, below] at (-1.1, -1) {Registrierung};
\node [light, below] at (1.1, -2) {Map Shift};
\node [light, above] at (2, 2) {TSDF Update};
\node [light, below] at (3.5, -2) {Visualisierung};
\end{tikzpicture}
\begin{tabular}{|p{2cm}||p{2cm}|p{2cm}|p{2cm}|}
\hline
 & Durchschnitt & Min & Max \\\hline
U [mV] & 60.2 & 57.3 & 66.7 \\
I [A] & 0.86 & 0.82 & 0.95 \\
P [W] & 10.32 & 9.84 & 11.4 \\\hline
\end{tabular}
\end{center}
\end{frame}
