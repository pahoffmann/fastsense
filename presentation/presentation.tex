...
\begin{frame}{\subsecname}
\begin{itemize}
\item Kommunikatioin via 'Bridge': \\Schnittstelle zwischen Sensordaten / berechneten Daten auf Trenz Board und einem Host Computer mit ROS
...
\node [below] at (20, 0) {\begin{minipage}{6cm}
\begin{itemize}
\item{Visualisierung und Überprüfung mit ROS Tools}
\item{Aufnahme zur Verarbeitung und Evaluation}
\end{itemize}
\end{minipage}};
\end{tikzpicture}
\end{center}
